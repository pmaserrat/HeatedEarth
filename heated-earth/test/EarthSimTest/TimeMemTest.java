...
public class TimeMemTest extends TestCase {
	...
	public void test_Buffer_None() {
		BaseTest.test(1, 10, 1, ThreadConfig.NONE, CommunicationConfig.BUFFER);
		BaseTest.test(1, 5, 4, ThreadConfig.NONE, CommunicationConfig.BUFFER);
	}

	public void test_Buffer_Pres() {
		BaseTest.test(1, 10, 1, ThreadConfig.PRESENTATIONONLY,
				CommunicationConfig.BUFFER);
		BaseTest.test(1, 5, 4, ThreadConfig.PRESENTATIONONLY,
				CommunicationConfig.BUFFER);
		BaseTest.test(1, 10, 1, ThreadConfig.PRESENTATIONONLY,
				CommunicationConfig.BUFFER);
	}

	public void test_Buffer_Simulation() {
		BaseTest.test(1, 10, 1, ThreadConfig.SIMULATIONONLY,
				CommunicationConfig.BUFFER);
		BaseTest.test(1, 5, 4, ThreadConfig.SIMULATIONONLY,
				CommunicationConfig.BUFFER);
	}

	public void test_Buffer_Both() {
		BaseTest.test(1, 10, 1, ThreadConfig.SIMULATIONANDPRESENTATION,
				CommunicationConfig.BUFFER);
		BaseTest.test(1, 5, 4, ThreadConfig.SIMULATIONANDPRESENTATION,
				CommunicationConfig.BUFFER);
	}
}
